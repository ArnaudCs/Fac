...
int main(int argc, char * argv[]){
  ...
  valinit.array = tabinit; //créer le tableau init de taille nbsémaphores avec comme valeur initiale param du programme
  ...
  if (semctl(idSem, nbSem, GETALL, valinit) == -1){  //getall récupère les valeurs des sémaphores
    perror("erreur initialisation sem : ");
    exit(1);
  } 
